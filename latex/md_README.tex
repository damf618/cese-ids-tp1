...
```c bool Esteban\+Volentini(char $\ast$ cadena, size\+\_\+t espacio) \{ struct alumno\+\_\+s alumno = \{ .apellidos = \char`\"{}\+V\+O\+L\+E\+N\+T\+I\+N\+I\char`\"{}, .nombres = \char`\"{}\+Esteban Daniel\char`\"{}, .documento = \char`\"{}23.\+517.\+968\char`\"{}, \};
